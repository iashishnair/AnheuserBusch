...
#import "CustomSegmentedCollectionViewCell.h"
#import "CustomSegmentedCollectionViewLayout.h"

@interface CustomSegmentedView () <UICollectionViewDataSource, UICollectionViewDelegate, UIScrollViewDelegate>
...
+ (CustomSegmentedView*) viewWithListTitle:(NSArray*)listTitle {
    CustomSegmentedView *view = [CustomSegmentedView initViewUsingNib];
...
- (void) setupCollectionView {
    ...
    [self.collectionView registerNib:[CustomSegmentedCollectionViewCell nib] forCellWithReuseIdentifier:[CustomSegmentedCollectionViewCell nibName]];
    
    self.collectionView.collectionViewLayout = [[CustomSegmentedCollectionViewLayout alloc] init];
...
- (UICollectionViewCell*) collectionView:(UICollectionView *)collectionView_ cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    CustomSegmentedCollectionViewCell *cell = (CustomSegmentedCollectionViewCell*)[collectionView_ dequeueReusableCellWithReuseIdentifier:[CustomSegmentedCollectionViewCell nibName] forIndexPath:indexPath];
