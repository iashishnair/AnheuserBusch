...
#import "CustomPageManagerViewController.h"

@interface CustomPageManagerViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate, LTSegmentedViewDelegate>

@end

@implementation CustomPageManagerViewController
...
- (void) setupSegmentedView {
    if (!self.disibleSegmentView) {
        self.segmentedView = [CustomSegmentedView viewWithListTitle:self.segmentTitles];
